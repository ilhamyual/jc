...
if( empty( $_SESSION['id_user'] ) ){
	...
	die();
      ...
      if(isset($_REQUEST['submit'])){
		 ...
		 <h2>Rekap Laporan Penghasilan <small>'.$tgl1.' sampai '.$tgl2.'</small></h2><hr>
	 ...
	 echo '
		...
		echo '<div style="background-image:url(image/1.jpg)">';
		echo '
		<b><h2>Rekap Laporan Penghasilan Hari Ini</b> (<small><h7>'.date('d-m-Y').'</h7></small>)</h2><hr>
		<style>
		h7 {
			color: black;
		}
...
?>
	<div style="background-image:url(image/1.jpg)" class="well well-sm noprint">
...
<?php
      ...
      echo '<div style="background-image:url(image/1.jpg)" class="col-sm-6"><table class="table table-bordered">';
      echo '<tr class="info"><th><h4>Jumlah Pelanggan</h4></th><th><h4>Jumlah Pendapatan</h4></th></tr>';
